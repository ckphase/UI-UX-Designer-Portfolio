...
export function PhilosophySection() {
  ...
  return (
    <div className="relative w-full h-full flex items-center justify-center overflow-hidden bg-neutral-900">
      ...
      {/* Background Text with One-Time Grey Gleam */}
      <motion.div
        initial={{ opacity: 0 }}
      ...
      >
        <div className="flex text-[25vw] leading-none font-bold whitespace-nowrap">
          {word.split('').map((char, index) => (
            <motion.span
              key={index}
              initial={{ color: '#6b6b6b' }}
              animate={{
                color: ['#6b6b6b', '#cfcfcf', '#6b6b6b'],
              }}
              transition={{
              ...
              className="
                bg-[linear-gradient(110deg,#6b6b6b,#cfcfcf,#6b6b6b)]
                bg-[length:200%_100%]
                bg-clip-text
                text-transparent
              "
