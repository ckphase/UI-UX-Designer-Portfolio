      ...
      <div className="relative z-10 max-w-5xl mx-auto px-8 md:px-16 text-center">
        ...
        >
          {[
            {
              title: 'Intentional',
              description: 'Every element serves a purpose. Every choice tells a story.'
            },
            {
              title: 'Timeless',
              description: 'Creating work that transcends trends and stands the test of time.'
            },
            {
              title: 'Human-Centered',
              description: 'Designing experiences that connect, resonate, and inspire.'
            }
          ].map((item, index) => (
            <motion.div
              key={item.title}
            ...
            >
              ...
              <h3 className="text-xl md:text-2xl mb-3 tracking-wide">{item.title}</h3>
