...
const socialLinks = [
  { icon: Linkedin, label: 'LinkedIn', href: 'https://www.linkedin.com/in/chandanpreetkaursandhu/' },
...
export function ContactSection() {
  return (
    <div className="relative w-full h-full flex items-center justify-center overflow-hidden bg-neutral-900">
      ...
      >
        <div className="text-[40vw] leading-none font-bold text-white">
          @
        </div>
      </motion.div>
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto px-8 md:px-16 text-center">
        ...
        >
          {socialLinks.map((social, index) => (
            <motion.a
              ...
              transition={{ duration: 0.4, delay: 0.8 + index * 0.1, type: 'spring', stiffness: 200 }}
        ...
        >
          <div className="space-y-2">
            <h3 className="text-sm tracking-wider text-white/50 uppercase">Location</h3>
            <p className="text-base md:text-lg">Remote</p>
          </div>
          <div className="space-y-2">
            <h3 className="text-sm tracking-wider text-white/50 uppercase">Availability</h3>
            <p className="text-base md:text-lg">Open for projects</p>
          </div>
          <div className="space-y-2">
            <h3 className="text-sm tracking-wider text-white/50 uppercase">Response Time</h3>
