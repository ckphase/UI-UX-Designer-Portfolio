import { Camera, Layout, Palette, Sparkles } from 'lucide-react';
...
const services = [
  {
    ...
    description:
      'Crafting unique visual identities that capture the essence of your brand and resonate with your audience.',
  ...
  },
  {
    ...
    description:
      'Creating beautiful, intuitive interfaces that provide seamless user experiences across all platforms.',
  ...
  },
  {
    ...
    description:
      'Leading creative vision from concept to execution, ensuring consistency and excellence in every detail.',
  ...
  },
  {
    ...
    description:
      'Producing compelling visual content that engages audiences and elevates your brand presence.',
